<x-layout-app page-title="Novo Usuário normal">

    <div class="w-100 p-4">

        <h3>Novo Colaborador normal</h3>
                    ...
                    <div class="col border border-black p-4">
                        ...
                        <div class="mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{route('departments.newDepartment')}}"
                        ...
                        <p class="mb-3">Perfil: <strong>Colaborador normal</strong></p>
